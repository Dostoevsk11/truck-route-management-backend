...
@Schema(
        name = "CreateTruckResource",
        description = "Resource for creating a new truck",
        example = """
                {
                  "plate": "ABC-123",
                  "brand": "Volvo",
...
public record CreateTruckResource(
        ...
        @Schema(
                description = "Number of truck axles",
                example = "3"
        )
        int axles,

        @Schema(
                description = "Truck current status",
                example = "AVAILABLE"
        )
        String truckStatus,
